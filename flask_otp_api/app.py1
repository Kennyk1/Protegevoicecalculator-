...
import time
import requests
from config import SUPABASE_URL, SUPABASE_KEY, OTP_API_KEY, OTP_EXPIRY_SECONDS, JWT_SECRET, JWT_ALGORITHM, OTP_SENDER_ID
...
OTP_TEMPLATE = "bbdb4949-9bfd-46d6-9545-746d6d79b648"  # your template ID
